...
export default function HeroSection({
  ...
  useGSAP(
    () => {
      ...
      const heroBottom =
        galleryWrapperRef.current?.getBoundingClientRect().bottom ?? Infinity;
      ...
      mm.add("(min-width: 1024px)", () => {
        ...
        const createScrollTimeline = () => {
          ...
          tl.to(
            ...
            { gap: "1.5rem", duration: 1.5, ease: "power2.inOut" },
            0,
          );
        ...
        if (isScrolledPastHero) {
          ...
          try {
            const saved = parseInt(
              sessionStorage.getItem("__mmg_scrollY") || "0",
              10,
            );
            if (saved > 0) {
    ...
    <div ref={containerRef} className="relative w-full">
      ...
      >
        ...
        <div
          ...
          className="relative z-10 flex items-center justify-center w-full h-full max-w-[1400px] mx-auto mt-0 lg:mt-10"
        >
          {/* Left Side Image */}
          <div
            ref={leftImageRef}
            className="w-0 opacity-0 h-[80%] rounded-2xl overflow-hidden relative shrink-0 flex-none shadow-2xl"
          >
            <img
              src={leftSrc}
              alt="Team generating ideas"
              loading="eager"
              decoding="async"
          ...
          <div
            ref={mainImageRef}
            className="w-full h-full rounded-2xl overflow-hidden relative shrink-0 shadow-2xl"
          >
            <img
              src={heroSrc}
              alt="Main Hero"
